 ...
 */
//fun thirdDigit(number: Int): Int = (number - (number/1000)*1000) % 1000 / 100
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial.toDouble() * (1.0 + percent.toDouble() / 100.0).pow(3)
